...
st.caption("Switch the viewer to see the site from any user's perspective — now powered by a global synthetic dataset.")
...
# --- Sidebar: per-user settings + dataset controls ---
with st.sidebar:
...
with tabs[3]:
    ...
    st.info(
        ...
        "This scaffold lets you compare model behavior for multiple personas without auth."
    )
